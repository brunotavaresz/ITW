...
var vm = function () {
    ...
    self.deleteEntry = function (itemName) {
        var idx = self.HistoryCompetitionsArray.indexOf(itemName);
        self.HistoryCompetitionsArray.splice(idx, 1);
    ...
    self.searchChanged = function (event) {
        ...
        if (searchQuery.length >= 3) {
            ...
            typingTimeout = setTimeout(function () {
                ...
                var idx = self.HistoryCompetitionsArray.indexOf(searchQuery);
                if (idx == -1) {
                    self.HistoryCompetitionsArray.push(String(searchQuery));
                }
