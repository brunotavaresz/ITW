...
var vm = function () {
    ...
    self.deleteEntry = function (itemName) {
        var idx = self.HistoryModalitiesArray.indexOf(itemName);
        self.HistoryModalitiesArray.splice(idx, 1);
    ...
    self.setFavorites = function (id) {
        ...
        if (idx == -1) {
            ...
            $("#fav" + id).removeClass("text-danger").addClass("text-body-secondary");
    ...
    self.searchChanged = function (event) {
        ...
        if (searchQuery.length >= 3) {
            ...
            typingTimeout = setTimeout(function () {
                ...
                var idx = self.HistoryModalitiesArray.indexOf(searchQuery);
                if (idx == -1) {
                    self.HistoryModalitiesArray.push(String(searchQuery));
                }
